		...
		editor.addButton('designthemes_sc_button',{
			...
			menu:[
...

				{
					text: 'Events',
					onclick: function(){
						editor.selection.setContent('<br>[dt_sc_events limit="-1" carousel="true" /]<br>');
					}
				},
				...
				{ text:'Others',
					menu:[
						...
						{ text:'Slider Search Section',
							onclick: function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_slider_search title="Title Comes Here" button_title="" button_link="#" /]');
							}
						},
