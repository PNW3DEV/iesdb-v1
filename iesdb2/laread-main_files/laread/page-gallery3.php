...
get_header(); ?>
		...
		<div class="post-fluid">
			<div class="container">
				<div class="row masonry masonry-gallery isotopeContainer">
					...
					<?php 
						...
						if ( $laread_gallery_post_limit < 6 ) $laread_gallery_post_limit = 6;
			            $blog_args = array(
						...
						if($blog_query->have_posts()) : 
							...
							include 'gallery-format/gallery3/box.php';
			...
			<div class="container" id="more-down-v3">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<a href="#" class="more-down more-down-v3"><i class="fa fa-long-arrow-down"></i></a>
				</div>
			</div>
