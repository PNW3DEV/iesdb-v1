	...
	class TitanFrameworkChecker {
		...
		public function display_admin_notification_not_exist() {
			...
			echo "<div class='error'><p><strong>"
				. apply_filters( 'titan_checker_installation_notice', __( "Titan Framework needs to be installed.", "laread" ) )
				. sprintf( " <a href='%s'>%s</a>",
					admin_url( "plugin-install.php?tab=search&type=term&s=titan+framework" ),
					apply_filters( 'titan_checker_search_plugin_notice', __( "Click here to search for the plugin.", "laread" ) ) )
				. "</strong></p></div>";
		}
		...
		public function display_admin_notification_inactive() {
			...
			echo "<div class='error'><p><strong>"
				. apply_filters( 'titan_checker_activation_notice', __( "Titan Framework needs to be activated.", "laread" ) )
				. sprintf( " <a href='%s'>%s</a>",
					admin_url( "plugins.php" ),
					apply_filters( 'titan_checker_activate_plugin_notice', __( "Click here to go to the plugins page and activate it.", "laread" ) ) )
				. "</strong></p></div>";
		}
