...
defined( 'TF_I18NDOMAIN' ) or define( 'laread', 'titan-framework' );
...
class TitanFrameworkPlugin {
	...
	public function load_text_domain() {
		load_plugin_textdomain( 'laread', false, basename( dirname( __FILE__ ) ) . '/languages/' );
	}
