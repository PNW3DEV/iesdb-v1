...
get_header(); ?>
	...
	<div class="container">
		<div class="head-about">
			...
			<p class="lead about-lead"><?php echo esc_html($description);?></p>
		</div>
	</div>
				...
				<div class="row laread-about">
					...
					<ul class="about-social">
						...
						<?php if ($social_about_contact_mail): ?>
							<li><a href="mailto:<?php echo $social_about_contact_mail; ?>"><i class="fa fa-envelope"></i></a></li>		
						<?php endif ?>
					</ul>
