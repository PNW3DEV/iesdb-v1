...
<div class="gallery-large-item gallery-item <?php if ($categorys): ?><?php foreach ($categorys as $l => $v): ?><?php echo $v->slug,' '; ?><?php endforeach ?><?php endif ?>">
					...
					<?php if (count($gallery)): ?>
						<div id="carousel-example-generic--<?php the_ID(); ?>" class="carousel slide" data-ride="carousel">
							...
							<a class="left carousel-control carousel-middle" href="#carousel-example-generic--<?php the_ID(); ?>" role="button" data-slide="prev"><i class="fa fa-angle-left"></i></a>
							<a class="right carousel-control carousel-middle" href="#carousel-example-generic--<?php the_ID(); ?>" role="button" data-slide="next"><i class="fa fa-angle-right"></i></a>
						</div>
						<?php endif ?>
					</div>
