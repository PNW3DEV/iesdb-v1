<?php /* Template Name: Banner Mode v1 */ 
/**
        ...
        <div id="fullpage">
			...
			<div class="banner-mod" id="section0">
				...
				<div id="carousel-captions" class="carousel slide carousel-fade" data-ride="carousel" data-interval="99999999">
						...
						<div class="item <?php echo ($s==1) ? 'active': ''; ?>">
							...
							<div class="item-cover" style="background-image: url('<?php echo $image; ?>');">
								...
								<div class="carousel-caption carousel-caption-1">
									<span class="article-info"><?php echo get_the_date('d'); ?> <span><?php echo get_the_date('F'); ?>
									</span></span>
									<h3><a href="<?php echo esc_url(get_permalink()); ?>"><?php the_title(); ?></a></h3>
									<p><?php $summary = get_the_excerpt(); echo strip_tags($summary); ?></p>
								</div>
					...
					<a href="#" class="caption-more"><?php echo esc_attr__('MORE', 'laread' ); ?> <i class="fa fa-chevron-circle-down"></i></a>
				</div>
