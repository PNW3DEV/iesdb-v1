		...
		for ( var h in c) {
			...
			if(ctype == 'type13') {
				...
				g += "[dt_sc_"
					+ e
					+ "] <br/>"
					+ '[dt_sc_icon_box ' + type + ' fontawesome_icon="'+current_icon +'" title="Title Comes Here" link="#" custom_icon="'+custom_icon +'" custom_bgcolor="'+custom_bgcolor +'" /]'
				g += " <br> [/dt_sc_" + z
					+ "]";
				...
				g += "[dt_sc_"
					+ e
					+ "] <br/>"
					+ '[dt_sc_icon_box ' + type + ' fontawesome_icon="'+current_icon +'" title="Title Comes Here" link="#" custom_icon="'+custom_icon +'" /]'
				g += " <br> [/dt_sc_" + z
					+ "]";
				...
				g += "[dt_sc_"
					+ e
					+ "] <br/>"
					+ '[dt_sc_icon_box ' + type + ' fontawesome_icon="'+current_icon +'" title="Title Comes Here" link="#" custom_icon="'+custom_icon +'"]<br>'
