    ...
    if( $ptemplate_select.length ) {
		$ptemplate_select.live('change', function(){
			...
			switch($val){
				...
				case 'tpl-courses.php':
				
					$ptemplate_box.find('span:first').text('Courses Options');
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
					$ptemplate_box.find('#tpl-common-settings').slideDown();
					$ptemplate_box.find('#tpl-courses').slideDown();
					$ptemplate_box.find("#page-layout").slideDown();
					if($ptemplate_box.find('#mytheme-page-layout').val() == 'content-full-width')
						$ptemplate_box.find("#widget-area-options").slideUp();
					else
				...
				case 'tpl-landingpage.php':
					...
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
					$ptemplate_box.find('#tpl-common-settings').slideUp();
					$ptemplate_box.find('#tpl-default-settings').slideUp();
					$ptemplate_box.find('#custom-style-settings').slideUp();
					$ptemplate_box.find("#page-layout").slideUp();
					$ptemplate_box.find("#widget-area-options").slideUp();
