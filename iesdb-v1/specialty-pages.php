...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
         ...
         <?php $sub_menus = array(
					...
					array("title"=>__("Teacher Archives",'dt_themes'), "link"=>"#teacher-archives"),
		...
		$tabs = array(
				...
				array(  "id"=>"teacher-archives", 
						"layout-title"=>__("Teacher Custom Post's Archive Page Layout",'dt_themes'),
						"layout-tooltip"=>__("You can choose between a left, right or no sidebar layout for the Teacher custom post's Archive page.",'dt_themes'),
						"post-layout-title" => __("Posts Layout",'dt_themes'),
						"post-layout-tooltip"=>__("Your archive results will use the layout you select below.",'dt_themes'),                                
