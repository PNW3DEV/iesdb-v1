<?php 
	...
	if( $teacher_archives_layout != "content-full-width" ){
		if( $teacher_archives_layout == "with-left-sidebar" || $teacher_archives_layout == "both-sidebar" ){
			register_sidebar(array(
				'name' 			=>	__("Teacher Archives Sidebar Left",'dt_themes'),
				'id'			=>	'custom-post-teacher-archives-sidebar-left',
				'description'   =>  __("Teacher archives sidebar that appears on the left.","dt_themes"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<h3 class="widgettitle">',
				'after_title' 	=> 	'</h3>'));
		...
		if( $teacher_archives_layout == "with-right-sidebar" || $teacher_archives_layout == "both-sidebar"){
			register_sidebar(array(
				'name' 			=>	__("Teacher Archives Sidebar Right",'dt_themes'),
				'id'			=>	'custom-post-teacher-archives-sidebar-right',
				'description'   =>  __("Teacher archives sidebar that appears on the right.","dt_themes"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<h3 class="widgettitle">',
				'after_title' 	=> 	'</h3>'));
	...
	if( dttheme_is_plugin_active('designthemes-core-features/designthemes-core-features.php') ):
		...
		if( $course_archives_layout != "content-full-width" ){
			if( $course_archives_layout == "with-left-sidebar" || $course_archives_layout == "both-sidebar" ){
				register_sidebar(array(
					'name' 			=>	__("Course Archives Sidebar Left",'dt_themes'),
					'id'			=>	'custom-post-course-archives-sidebar-left',
					'description'   =>  __("Course archives sidebar that appears on the left.","dt_themes"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<h3 class="widgettitle">',
					'after_title' 	=> 	'</h3>'));
			...
			if( $course_archives_layout == "with-right-sidebar" || $course_archives_layout == "both-sidebar"){
				register_sidebar(array(
					'name' 			=>	__("Course Archives Sidebar Right",'dt_themes'),
					'id'			=>	'custom-post-course-archives-sidebar-right',
					'description'   =>  __("Course archives sidebar that appears on the right.","dt_themes"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<h3 class="widgettitle">',
					'after_title' 	=> 	'</h3>'));
	...
	if( class_exists('WooThemes_Sensei') ) {
		...
		register_sidebar(array(
			...
			'description'	=>	__("Common sensei course sidebar that appears on the left.","dt_themes"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<h3 class="widgettitle">',
			'after_title' 	=> 	'<span></span></h3>'));
		...
		register_sidebar(array(
			...
			'description'	=>	__("Common sensei course sidebar that appears on the right.","dt_themes"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<h3 class="widgettitle">',
			'after_title' 	=> 	'<span></span></h3>'));
