			...
			if ("designthemes_sc_button" === btn) {
				...
				btn.onRenderMenu
						.add(function(c, b) {
							...
							/* Events */
							a.addImmediate(b, "Events", '<br>[dt_sc_events limit="-1" carousel="true" /]<br>');
							...
							var testimonal = '[dt_sc_testimonial name="John Doe" role="Cambridge Telcecom" type="type2" class=""]'+dummy_conent+'[/dt_sc_testimonial]';
							...
							a.addImmediate(c, "Plan A Visit Form",'[dt_sc_subscription_form image_url="" slider="LayerSlider / RevolutionSlider" slider_id="" title="Plan a Visit" submit_text="Submit" success_msg="Thanks for subscribing, we will contact you soon."  '
								+' error_msg="Mail not sent, please try again Later." subject="Subscription" enable_planavisit="true" contact_label="Inquiries" contact_number="0123456789"]');
							...
							a.addImmediate(c, "Slider Search Section",'[dt_sc_slider_search type="type1" title="Title Comes Here" button_title="" button_link="#" /]');
